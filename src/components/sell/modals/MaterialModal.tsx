/**
 * MaterialModal
 * Bottom sheet for selecting materials (multi-select with checkboxes)
 */
...
import { MATERIAL_OPTIONS } from '../../../constants/sellCategories';
...
export const MaterialModal: React.FC<MaterialModalProps> = ({
  ...
  const [localSelected, setLocalSelected] = useState<string[]>(selectedMaterials);
            ...
            {MATERIAL_OPTIONS.map((material) => (
              ...
              >
                <View style={styles.checkbox}>
                  {localSelected.includes(material.id) && (
